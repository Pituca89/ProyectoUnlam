...
public class ClienteHTTP_BATERIA extends AsyncTask<JSONObject,JSONObject,String> {
    ...
    public ClienteHTTP_BATERIA(android.support.v4.app.Fragment a){this.caller = (InterfazBateria) a;}
