...
import com.example.adagiom.bepim.adapter.SectorTrainingAdapter;
...
public class DriveFragment extends Fragment implements InterfazAsyntask {
            ...
            public void onClick(View view) {
                ...
                switch (view.getId()) {
                    ...
                    case R.id.btn_deshacer:
                        ...
                        builderDeshacer.setTitle("Atención!")
                                .setMessage("Desea volver a la posicion inicial?")
                                .setPositiveButton("CONFIRMAR", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        try{
                                            mConnectedThread.write("W");
                                            mostrarToastMake("Volviendo al inicio...");
                                        }catch (Exception e){
                                            mostrarToastMake("Plataforma desconectada");
                                        }
                                    }
